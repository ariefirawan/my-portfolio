  ...
  >
    ...
    >
      <AnimationWrap delay="300" duration="800">
        ...
        <Styled.p sx={{ mb: 0 }}>
          I’m a freelance <strong>Full Stack Developer</strong> specializing
          <strong> NodeJS</strong> and React in building a web interface with
        ...
        <Button
          as={OutboundLink}
          href="https://docs.google.com/document/d/1WYP_0cbpw-Uu_z-IGPOPTROdWswCf8a7/edit"
          target="_blank"
